...
class tx_march8_t3dimport {
	...
	public function main($params, $pObj) {
		...
		if (t3lib_div::_GP('doImport') && $fieldValue) {
			...
			$flashText = 'Your import of the template objects was successful. Do not hit the import button again. You have now completed the extension installation.';
	...
	protected function importTemplateObjects($pid) {
		$templateObjectPath = t3lib_extMgm::extPath('march8') . 'template_objects.t3d';
		$data = null;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/march8/class.tx_march8_t3dimport.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/march8/class.tx_march8_t3dimport.php']);
}
