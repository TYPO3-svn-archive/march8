...
class ux_t3lib_tsparser_ext extends t3lib_tsparser_ext {
	...
	function includeStaticTypoScriptSources($idList, $templateID, $pid, $row) {
		...
		tx_march8_lib::includeTypoScriptForFrameworkCoreAndSkins($_params, $this);
	}
}

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/march8/xclass/class.ux_t3lib_tsparser_ext.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/march8/xclass/class.ux_t3lib_tsparser_ext.php']);
}
?>