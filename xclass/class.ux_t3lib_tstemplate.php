...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/march8/xclass/class.ux_t3lib_tstemplate.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/march8/xclass/class.ux_t3lib_tstemplate.php']);
}
?>